...
{
    public abstract class YootekWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static YootekWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(YootekWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<YootekDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<YootekDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<YootekDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<YootekDbContext, Task<T>> func)
        {
            T result;
